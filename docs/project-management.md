# Gestión del Proyecto — Top 5 de Todo

Este documento describe cómo estoy organizando el trabajo del proyecto fullstack utilizando un enfoque Kanban y un tablero en Trello. El objetivo es mantener una visión clara del estado del desarrollo, priorizar tareas y avanzar de forma ordenada y profesional.
